...
export class Backend implements backendInterface {
    ...
    async addInventory(arg0: Array<InventoryInit>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addInventory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createInquiry(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createInquiry(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInventory(): Promise<Array<Car>> {
        if (this.processError) {
            try {
    ...
    async setAvailability(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setAvailability(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
